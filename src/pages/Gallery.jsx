...
const Gallery = () => {
  return (
    ...
    <div id="about" className='relative flex flex-col w-full h-[500px]'>
      <img className='w-full  h-full object-cover' src="https://goldenplaterestaurant.net/wp-content/uploads/2023/10/Contact-background-scaled.jpg" alt="image" />
      ...
      <div className="absolute flex flex-col w-full h-full justify-center items-center">
        ...
        className="text-3xl md:text-5xl text-white font-bold">Gallery</motion.h1>
      </div>             
    </div>
    <GalleryItems />
    <Footer />
