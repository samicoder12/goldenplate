    ...
    <div className='w-full h-[1410px] md:h-[870px] lg:h-[800px]  bg-green '>
        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 space-y-3 md:space-y-0 md:gap-10 px-2 xl:px-0">
            ...
            <div className="flex flex-col  space-y-4 mt-20 justify-center">
               ...
               <Link to="about"><motion.button whileTap={{scale:0.9}}   className="text-white text-sm 2xl:text-lg py-2 2xl:py-4 2xl:px-8 px-6 border border-[rgb(223,208,81)] rounded-md hover:bg-[rgb(223,208,81)] transition-transform duration-150 hover:text-black">Discover More</motion.button></Link>
               </motion.div>
            </div>
